                ...
                <div class="card shadow border-0">
                    <div class="job_details_header">
                        <div class="single_jobs white-bg d-flex justify-content-between">
                            ...
                            <div class="jobs_right">
                                <div class="apply_now">
                                    <a class="heart_mark" href="javascript:void(0)" onclick="saveCourse({{ $course->id }})"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="descript_wrap white-bg">
                        ...
                        <div class="pt-3 text-end">
                            ...
                            @if(Auth::check())
                                <a href="#" onclick="applyCourse({{ $course->id }})" class="btn btn-primary">Buy</a>
                            @else
                                <a href="javascript:void(0)" class="btn btn-primary disabled">Login to Buy</a>
                            @endif
                        </div>
                    </div>
                </div>
